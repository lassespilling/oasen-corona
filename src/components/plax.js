...
var vanillaJsuParallax = function(settings) {
    ...
    var scrollEvent = function() {
        ...
        if (winWidth >= minViewportWidth && winHeight >= minViewportHeight) {
            ...
            if (activeParallax) {
                activeParallax = 0;
                for (i = 0; i < itemsLen; i++) {
                    setTransformTranslate3d(
                        items[i].firstElementChild,
                        0,
                        0,
                        0
                    );
    ...
    var itemPrepareDefault = function(i, item) {
        ...
        /* Movement direction */
        opt.dir =
            item.getAttribute("data-jsuplxdir") == "bottom" ? "bottom" : "top";
        /* Movement perspective */
        var elPerspective = parseInt(
            item.getAttribute("data-jsuplxperspective"),
            10
        );
